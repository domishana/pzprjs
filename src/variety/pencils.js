...
FailCode:{
	ptNoPencil : ["幅が1の長方形の軸の先端に位置しない芯があります。","A tip is not at the short end of a 1xN rectangle."],
	ptInPencil : ["芯が他の鉛筆の軸に入り込んでいます。","A tip is inside a pencil."],
	pcMultipleTips : ["2つ以上の芯を持つ鉛筆があります。","A pencil has more than one tip."],
	nmSizeLt : ["中の数字よりも長くなっている軸があります。","A number is smaller than the length of the pencil."],
	nmSizeGt : ["中の数字よりも短くなっている軸があります。","A number is larger than the length of the pencil."],
	nmOutsidePencil : ["軸の中に入っていない数字があります。","A number is not inside a pencil."],
	lnCrossPencil: ["線が鉛筆の芯と交差しています。","A line crosses a pencil."],
	...
	lnLengthLt : ["鉛筆から引かれた線が芯よりも短くなっているところがあります。.","A line is shorter than the connected pencil."],
